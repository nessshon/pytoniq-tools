...
from .._base.collection import Collection
...
class CollectionSoulbound(Collection):
    ...
    def build_mint_body(
        ...
        :param revoked_at: The timestamp when the item is revoked. Defaults to 0.
    ...
    def build_batch_mint_body(
        ...
        :param data: The list of data for minting. Each tuple contains:
            ...
            - int: The timestamp when the item is revoked. DDefaults to 0.
